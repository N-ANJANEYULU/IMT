...
<title>${loginUser.firstName}</title>
</head>
<body>
  <div class="generic-container">
    ...
    <c:if test="${userRegistration.userId!=null}">
        ...
        <div class="row"  >
            <div class="form-group col-md-12">
                <label class="col-md-3 control-lable" for="isaccessGranted">is Access Granted</label>
                <div class="col-md-7">
                <form:select path="isaccessGranted" required="required" >
							<form:option value="" label="--- Select ---" />
